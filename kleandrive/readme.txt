...
Please install and activate it before starting to use the theme Planty.
...
Theme documentation is available on https://planty.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Planty is Fontello.
