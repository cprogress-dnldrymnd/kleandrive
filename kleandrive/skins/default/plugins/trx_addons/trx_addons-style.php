...
if ( ! function_exists( 'planty_trx_addons_get_css' ) ) {
	add_filter( 'planty_filter_get_css', 'planty_trx_addons_get_css', 10, 2 );
	function planty_trx_addons_get_css( $css, $args ) {
