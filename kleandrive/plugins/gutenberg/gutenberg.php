...
if ( ! function_exists( 'planty_gutenberg_save_css' ) ) {
	...
	function planty_gutenberg_save_css() {
		...
		// Get main styles
		//----------------------------------------------
		$css = apply_filters( 'planty_filter_gutenberg_get_styles', planty_fgc( planty_get_file_dir( 'style.css' ) ) );
...
if ( ! function_exists( 'planty_gutenberg_add_editor_colors' ) ) {
	//Hamdler of the add_action( 'after_setup_theme', 'planty_gutenberg_add_editor_colors' );
