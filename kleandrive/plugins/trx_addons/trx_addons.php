...
if ( ! function_exists( 'planty_trx_addons_theme_setup9' ) ) {
	...
	function planty_trx_addons_theme_setup9() {
		if ( planty_exists_trx_addons() ) {
			...
			add_filter( 'trx_addons_filter_video_dimensions', 'planty_trx_addons_video_dimensions' );
			add_filter( 'planty_filter_video_dimensions', 'planty_trx_addons_video_dimensions_in_video_list' );
...
if ( ! function_exists( 'planty_trx_addons_video_dimensions' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_video_dimensions', 'planty_trx_addons_video_dimensions' );
	function planty_trx_addons_video_dimensions( $dim ) {
		...
		return apply_filters( 'planty_filter_video_dimensions', $dim );
	}
}
...
if ( ! function_exists( 'planty_trx_addons_video_dimensions_in_video_list' ) ) {
	//Handler of the add_filter( 'planty_filter_video_dimensions', 'planty_trx_addons_video_dimensions_in_video_list' );
	function planty_trx_addons_video_dimensions_in_video_list( $dim ) {
		// If inside "Video list" - reduce dimensions, because controller is present
