                                ...
                                <div class="inner">
                                    ...
                                    <div class="footer">
                                        <div class="sc_item_button sc_button_wrap">
                                            <button data-title="<?php the_title() ?>" data-bs-toggle="modal" data-bs-target="#applyModal" class="apply-button sc_button  sc_button_size_normal sc_button_icon_left color_style_link3">
